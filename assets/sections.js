...
import { EffectCarousel } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { timeline as timeline2, inView } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
...
import { Delegate } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
...
import { animate, timeline as timeline3, stagger, Delegate as Delegate2 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
import { AnimatedDetails, EffectCarousel as EffectCarousel2, Drawer, throttle } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { animate as motionAnimate, scroll } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
...
import { scroll as scroll2, timeline as timeline4, animate as animate2, inView as inView2 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
import { imageLoaded, getHeadingKeyframe } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { ScrollArea } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { animate as animate3, timeline as timeline5, inView as inView3 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
import { getHeadingKeyframe as getHeadingKeyframe2, throttle as throttle2 } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { animate as animate4, inView as inView4 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
...
import { timeline as timeline6, inView as inView5 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
...
import { animate as animate5, timeline as timeline7, inView as inView6 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
import { imageLoaded as imageLoaded2 } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { timeline as timeline8, animate as animate6, stagger as stagger2, inView as inView7 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
import { EffectCarousel as EffectCarousel3, imageLoaded as imageLoaded3, getHeadingKeyframe as getHeadingKeyframe3 } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { Drawer as Drawer2 } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
var NewsletterPopup = class extends Drawer2 {
  connectedCallback() {
    super.connectedCallback();
    if (this.shouldAppearAutomatically) {
      setTimeout(() => this.showNewsletterPopup(), this.apparitionDelay);
    }
  }
  get initialFocus() {
    return false;
  ...
  showNewsletterPopup() {
    const returningCustomerPopupEl = document.querySelector('returning-customer-popup')

    if (returningCustomerPopupEl && returningCustomerPopupEl.hasAttribute('open')) {
      return
    }
...
// js/sections/returning-customer-popup
import { Drawer as Drawer3 } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
var ReturningCustomerPopup = class extends Drawer3 {
  connectedCallback() {
    super.connectedCallback();
    if (this.shouldAppearAutomatically) {
      setTimeout(() => this.showReturningCustomerPopup(), this.apparitionDelay);
    }
  }
  get initialFocus() {
    return false;
  ...
  get shouldAppearAutomatically() {
    return !(this.hasAttribute("only-once") && localStorage.getItem("theme:returning-customer-popup-appeared") === "true");
  }
  attributeChangedCallback(name, oldValue, newValue) {
    super.attributeChangedCallback(name, oldValue, newValue);
    if (name === "open" && this.open) {
      localStorage.setItem("theme:returning-customer-popup-appeared", "true");
    }
  }
  showReturningCustomerPopup() {
    const newsletterPopupEl = document.querySelector('newsletter-popup')
    const continueStepperButton = document.querySelector('[data-returning-customer-popup-cta]')
    const selectedVehicle = window.Convermax?.getVehicle()

    if (newsletterPopupEl?.hasAttribute('open') || !selectedVehicle) {
      return
    }

    this.show()
    
    // Setup cta to link to stepper with saved progress
    continueStepperButton.addEventListener('click', () => { 
      this.hide()
      if (window.stepper) {
        window.stepper.setMakeModelYear(selectedVehicle.Make, selectedVehicle.Model, selectedVehicle.Year)
      } else {
        window.location.href = '/pages/toms-key-finder?Make=' + selectedVehicle.Make + '&Model=' + selectedVehicle.Model + '&Year=' + selectedVehicle.Year
      }
    })
  }
};
if (!window.customElements.get("returning-customer-popup")) {
  window.customElements.define("returning-customer-popup", ReturningCustomerPopup);
}

// js/sections/press.js
import { timeline as timeline9, animate as animate7, inView as inView8 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
import { EffectCarousel as EffectCarousel4 } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { extractSectionId } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
...
import { scroll as scroll3, timeline as timeline10, ScrollOffset, inView as inView9 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
...
import { animate as motionAnimate2, timeline as timeline11, inView as inView10 } from "//tomskey.com/cdn/shop/t/45/assets/vendor.min.js?v=101728284033374364961689694119";
import { EffectCarousel as EffectCarousel5, imageLoaded as imageLoaded4, getHeadingKeyframe as getHeadingKeyframe4 } from "//tomskey.com/cdn/shop/t/45/assets/theme.js?v=14592841702234936931726665939";
